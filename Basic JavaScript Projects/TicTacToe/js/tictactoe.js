...
//This funtion is for placing an x or o in the square.
...
function checkWinConditions() {
    ...
    // O 3, 4, 5 condition.
    else if (arrayIncludes('OO', 'OO', 'OO')) { drawWinLine(50, 304, 558, 304) }
    // O 6, 7, 8 condition.
    ...
    // squares are seleced the code executes.
    ...
    function arrayIncludes(squareA, squareB, squareC) {
        // These 3 variables will be used to check for 5 in a row.
...
//This line accesses our html canvas element.
    ...
    function animateLineDrawing() {
        ...
        c.stroke();
        //This condistion checks if we've reached the endpoint.
        if (x1 <= x2 && y1 <= y2) {
